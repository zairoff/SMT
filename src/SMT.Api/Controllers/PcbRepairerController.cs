...
namespace SMT.Api.Controllers
{
    ...
    [ApiController]
    public class PcbRepairerController : ControllerBase
    {
        private readonly IPcbRepairerService _service;

        public PcbRepairerController(IPcbRepairerService service)
        {
            _service = service;
        }
